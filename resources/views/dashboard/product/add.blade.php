...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('title') }} " value="{{ old('title') }} " id="text"
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('sku') }} " id="number" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="product_sheet" class="form-control @error('product_sheet') is-invalid @enderror" id=""
                                        rows="5">{{ old('product_sheet') }}</textarea>
                                    @error('product_sheet')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <button type="button"
                                        class="btn btn-primary form-control mb-2 add-product-images">Add new image</button>
                                    <div class="input-group mb-1 p-img">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="clean_and_care" class="form-control @error('clean_and_care') is-invalid @enderror"
                                        id="exampleFormControlTextarea1" rows="5">{{ old('clean_and_care') }}</textarea>
    ...
    {{-- Dynamic Contents --}}
    <div class="upload-row d-none">
        <div class="row mb-1">
            <div class="col-md-8">
                <div class="custom-file">
                    <input type="file" required name="product_images[]" class="custom-file-input"
            ...
            <div class="col-md-4">
                <button type="button" class="btn btn-danger form-control rem-p-image">Remove</button>
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    <script>
        ...
        $('.add-product-images').click(function() {
            $('.p-img').append($('.upload-row').html());
        });
        $('.p-img').on('click', '.rem-p-image', function() {
