...
<section class="product-single">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 product-selection">
                        ...
                        <div class="_p-price-box">
                            <div class="p-list mb-4 pb-2">
                                <strong>
                                    ...
                                    <span class="price" id="price">
                                        ...
                                        $product->variant->max('sales_price') : Config::get('app.currency_code') .
                                        $product->variant->min('sales_price') }}
                                    </span>
                                </strong>
                            </div>
                            ...
                            <form action="{{ route('checkout') }}" method="get" id="product-form">
                                ...
                                <div class="_p-qty-and-cart mt-4 d-flex">
                                    ...
                                    <button class="btn btn-buy" @if ($product->variant->count() != 1) disabled
                                        @endif
                                        tabindex="0">
                                ...
                                <a href="{{ route('view-item', $suggestion->product_id) }}">
                                    ...
                                    <p>
                                        <span>{{ $suggestion->variant->count() > 1
                                            ...
                                            : Config::get('app.currency_code') .
                                            $suggestion->variant->min('sales_price') }}</span>
                                    </p>
                                </a>
                            </div>
